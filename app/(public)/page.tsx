...
export default function Home() {
  return (
    <div className="space-y-16">
      <section className="flex min-h-screen flex-col justify-center rounded-4xl border border-neutral-200/70 bg-linear-to-br from-white via-white to-neutral-50 p-10 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-12">
      ...
      <section className="flex min-h-screen flex-col justify-center rounded-4xl border border-neutral-200/70 bg-white p-10 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-12">
